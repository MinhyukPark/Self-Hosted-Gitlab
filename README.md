# Self-hosted Gitlab!
Visit at [Git.MinhyukPark.com](https://Git.MinhyukPark.com)!

## List of repositories mirrored to github:
- [This Repository](https://git.minhyukpark.com/MinhyukPark/self-hosted-gitlab) 
- [API](https://git.minhyukpark.com/MinhyukPark/API)
- [privacy\_policy](https://git.minhyukpark.com/MinhyukPark/privacy_policy)
- [dotfiles](https://git.minhyukpark.com/MinhyukPark/dotfiles)
- [Musictude](https://git.minhyukpark.com/MinhyukPark/musictude)
